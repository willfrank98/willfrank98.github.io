...
= 3.3.6 =
* Fixing issue with local storage object not clearing. This bug may have artificially inflated split testing results.

= 3.3.5 =
* Adding sanitization for better security.

= 3.3.4 =
* Adding sanitization to fix possible xss exploits.
